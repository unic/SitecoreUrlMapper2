...
|HandleQueryString|Adds query string regex pattern within the term field. Set to `x` to handle query string in requested URL, it automatically also enable regex support|
