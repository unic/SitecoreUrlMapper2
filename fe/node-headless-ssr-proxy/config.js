 ...
 */
const bundlePath = process.env.SITECORE_JSS_SERVER_BUNDLE || `./dist/urlmapper-jss-app/server.bundle`;
...
const config = {
   ...
   */
  apiHost: process.env.SITECORE_API_HOST || 'http://urlmapper2.dev.local',
  /**
   ...
   * Required.
   */
  apiKey: process.env.SITECORE_API_KEY || serverBundle.apiKey || '{F02CC0B5-BF7B-41B0-B570-C398A59FEC19}',
  /**
